...
class FactFileInitiates(InstalTestCase):
    ...
    def test_iaf_fluent_pow_exogenous(self):
        ...
        pow_ex_a_condition = [{"holdsat": ["holdsat(pow(ex_a(foo)),fact)"]}]
    ...
    def test_iaf_fluent_pow_institutional(self):
        ...
        pow_in_a_condition = [{"notholdsat": ["holdsat(pow(in_a(foo)),fact)"]}]
    ...
    def test_iaf_fluent_obligation(self):
        ...
        pow_in_a_condition = [
            {"holdsat": ["holdsat(obl(in_a(foo), in_b(foo), vi_c(foo)),fact)"]}]
