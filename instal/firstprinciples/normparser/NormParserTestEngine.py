...
NORMPARSER_TYPE_DICTIONARY = {
    ...
    "power": ["pow(ex_no)", "pow(ex_no2)"],
    "obligation": ["obl(in_a, in_b, vi_no)", "obl(in_a, in_b, vi_no2)"],
...
class NormParserTestEngine(InstalTestCase):
    ...
    IAL_PRELUDE = """
        ...
        violation event vi_no;
        violation event vi_no2;
        fluent flu_a;
        fluent flu_b;
        noninertial fluent nif_a;
        noninertial fluent nif_b;
        obligation fluent obl(in_a, in_b, vi_no);
        obligation fluent obl(in_a, in_b, vi_no2);
        """
